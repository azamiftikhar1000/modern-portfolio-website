...
_Note: Learn more about publish/subscribe in the [distributed communication patterns in NATS](https://azamiftikhar.dev/blog/distributed-communication-patterns-nats) article._
...
_Note: Learn more about request/reply in the [distributed communication patterns in NATS](https://azamiftikhar.dev/blog/distributed-communication-patterns-with-nats-g17) article._
...
In this article, we took a brief look at NATS CLI and learned about some basic CLI commands. This will help us to manage our NATS server easily and any extra dependency! Feel free to [reachout](https://www.azamiftikhar.dev/?action=contact) if you have any questions.
