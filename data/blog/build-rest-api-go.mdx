...
_All the code from this article is available [here](https://github.com/azamiftikhar1000/tutorials/tree/master/go/crud)_

```
$ go mod init ""/tutorials/go/crud
```
...
import (
	...
	"github.com/gorilla/mux"
	"""/tutorials/go/crud/pkg/handlers"
)
...
import """/tutorials/go/crud/pkg/models"
...
As mentioned above, the code is available [here](https://github.com/azamiftikhar1000/tutorials/tree/master/go/crud)
