...
This article builds up on the last part where we built a simple [REST API with Go](https://azamiftikhar.dev/blog/build-rest-api-go). Now, let's connect our API with a real database! Here, we will use PostgreSQL and [GORM](https://gorm.io/) to accomplish this.

**All the code from this article is available [here](https://github.com/azamiftikhar1000/tutorials/tree/master/go/gorm)**
