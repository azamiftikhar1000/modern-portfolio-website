...
export const projects: Project[] = [
  {
    ...
    website: 'https://github.com/azamiftikhar1000/HyperTrade',
    description:
    ...
    repository: 'https://github.com/azamiftikhar1000/HyperTrade',
    stack: [
      Stack.nats,
      Stack.go,
      Stack.typescript,
    ...
    deployment: {
      web: 'https://github.com/azamiftikhar1000/HyperTrade',
    },
    subProjects: [],
  },
  {
